...
let targetDate = new Date('July 08, 2026 00:00:00').getTime();
...
function updateCountdown() {
    ...
    if (timeRemaining <= 0) {
        document.getElementById('count').innerHTML = 'Happy Birthday Nidhu';
...
const correctPassword = "nidhu08";  // Replace with the password you want
...
document.getElementById("form").addEventListener("submit", function (event) {
    ...
    const mailtoLink = `https://wa.me/+919784317690?text=Greeting by Nidhu: +${message}`;
